...
<body>
 ...
 <div class="ass"> 
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="item">
                    <img src="img/m1.jpg" alt="New york" style="width:100%;height:500px">
                </div>
                <div class="item">
            ...
            <div class="upcomming">
                ...
                <div class="upcm">
                    <center>
                        <img src="imgsas/tm3.jpg" height="230px"  width="300px" border-radius="10px">
                        <h3> God Father</h3>
                        <button>Book</button>
                        </center>
                </div>
           ...
           <center>  <h1 class="upch"> UP  COMMING MOVIES</h1></center> 
            ...
            <div class="upcomming">
                <div class="upcm">
                    <center>
                    <img src="imgsas/upm1.jfif" height="230px"  width="300px">
                    <h3> God Father</h3>
                    <button>Book</button>
                    </center>
                ...
                <div class="upcm">
                    <center>
                        <img src="imgsas/upm5.jpg" height="230px", width="300px">
                        <h3>Salaar</h3>
                        <button>Book</button>
                        </center>
                ...
                <div class="upcm">
                    <center>
                        <img src="/m6.jpg" height="230px", width="300px">
                        <h3> Avathar -2 </h3>
                        <button>Book</button>
                        </center>
